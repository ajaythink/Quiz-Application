...
public class Quiz extends JFrame implements ActionListener {
    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() == next) {
            ...
            for (int i = 0; i < useranswers.length; i++) {
                if (useranswers[i][0].equals(questions.get(i).getAnswer())) {
                    score += 10;
                } else {
                    score += 0;
                }
    ...
    public void start(int count) {
        ...
        opt4.setText(questions.get(count).getOption4());
        opt4.setActionCommand(questions.get(count).getOption4());
    ...
    public void fetchQuestionsFromDatabase() {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                String answer = rs.getString("correct_option");
    ...
    public void saveScore(String name, int score) {
        ...
        try {
            // Change these values to your database configuration
            String url = "jdbc:mysql://localhost:3306/quiz_db";
            String user = "root";
            String password = "";
